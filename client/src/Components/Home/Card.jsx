...
const Card = ({author, date, id, k, image, title, summary}) => {
  ...
  if(k % 2 === 0){
    return (
      <a href="/posts" className="mb-5 h-auto md:h-[250px] flex flex-col justify-between md:flex-row border rounded-lg shadow border-gray-700 bg-gray-800 hover:bg-gray-700 overflow-hidden">
    ...
    return(
      <a href="/posts" class="mb-5 h-auto flex flex-col justify-between md:flex-row md:h-[250px]  border  rounded-lg shadow border-gray-700 bg-gray-800 hover:bg-gray-700 overflow-hidden">
