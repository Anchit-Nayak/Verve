...
const Card = (props) => {
  if(props.id % 2 === 0){
    return (
      <a href="#" class="mb-5 h-[500px] flex flex-col justify-between md:flex-row md:h-[250px] bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
        ...
        <div class="flex flex-col p-4 leading-normal justify-between pr-12">
          <div>
           ...
           <p className='text-primary-500'>{props.author} <span className='text-gray-500'>| {props.date}</span></p>
